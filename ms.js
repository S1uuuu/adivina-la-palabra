...
document.getElementById("player_answer").innerHTML="turno para contestar"+player2_name;
function send() {
...
var question_turn="plyer1";
var answer_turn="player2";
function check(){
var guardar=document.getElementById("input_check_box") .value;
var cambiar=guardar.toLowerCase();
if(cambiar==word){
